...
public class RhombusTest {
    ...
    private static final double INITIAL_MAJOR_DIAGONAL = 8.0;
    private static final double INITIAL_MINOR_DIAGONAL = 6.0;
    ...
    private static final double EXPECTED_AREA_1 = 24.0;
    ...
    public void when_rhombus_created_then_it_has_proper_name() {
        ...
        Rhombus rhombus = new Rhombus(INITIAL_MAJOR_DIAGONAL, INITIAL_MINOR_DIAGONAL);
    ...
    public void check_calculateArea_and_calculatePerimeter_should_return_proper_values(){
        ...
        Rhombus rhombus = new Rhombus(INITIAL_MAJOR_DIAGONAL, INITIAL_MINOR_DIAGONAL);
        Assert.assertEquals(rhombus.calculateArea(), EXPECTED_AREA_1, DELTA);
